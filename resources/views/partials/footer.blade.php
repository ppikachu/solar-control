<footer class="content-info py-5 bg-primary text-light">
  <div class="container">
    <div class="row">
    ...
    <div class="row mb-5">
      ...
      <div class="col-12 col-md-6 d-flex align-items-center">
        <div>
          <p><i class="fas fa-building"></i> Marconi 1346</p>
          <p><a class="text-light" href="tel:02392 56-5236"><i class="fas fa-phone"></i> 02392 56-5236</a></p>
          <p><strong>Horario de atención:</strong><br>Lunes a Viernes 8:30hs a 18:00hs / Sábado 9:00hs a 13:00hs</p>
          <p><a class="text-light" href="https://www.facebook.com/SOLARCONTROLPOLARIZADOS/" target="_blank"><i class="fab fa-facebook-square"></i></i> SOLAR CONTROL</a></p>
          <p><a class="text-light" href="https://www.instagram.com/solar__control/" target="_blank"><i class="fab fa-instagram"></i></i> SOLAR__CONTROL</a></p>
        </div>
      </div>
    </div>
    <hr>
